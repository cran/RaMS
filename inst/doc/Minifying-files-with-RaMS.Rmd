...
```{r download the mzXMLs, eval=FALSE}
...
The MSMS data wasn't uploaded, so we handle that separately by pulling it off
the lab computer manually and copying it over to our temporary directory. If
you're following along, you can skip this chunk or use your own DDA data.

```{r get DDA, eval=FALSE}
